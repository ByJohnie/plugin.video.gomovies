...
def CATEGORIES():
        addDir('Search','https://gomovies.sc/browse-word/',2,searchicon)
        addDir('All Movies','https://gomovies.sc/movies/',1,folder)
        addDir('TV-Series','https://gomovies.sc/tv-series/',1,folder)
